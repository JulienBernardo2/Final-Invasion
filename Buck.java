...
/**
 * Buck is the main actor which will be played by our player, he interacts 
 * with the second type of platform, not the first
 * @author (Julien, Phuc) 
 * @version (3)
 */
public class Buck extends Actor
{
    ...
    public boolean canMoveLeft()
    {
        ...
        int imageWidth = getImage().getWidth();
        int imageHeight = getImage().getHeight();
        if(getOneObjectAtOffset(imageWidth / -2 - STEP, imageHeight / -2, Platform2.class)!= null || 
        (getOneObjectAtOffset(imageWidth / -2 - STEP, imageHeight / 2 - 1, Platform2.class) != null))
        {
            canMoveLeft = false;
        }
